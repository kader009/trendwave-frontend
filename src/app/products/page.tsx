      ...
      <aside className="w-full lg:w-1/4 bg-white shadow-md p-6 lg:sticky lg:top-0 lg:h-screen">
        ...
        <div className="mb-6">
          ...
          <input
            ...
            className="w-full"
          />
          <p className="text-sm mt-1">${priceRange[0]} - ${priceRange[1]}</p>
        </div>
        ...
        {loading ? (
          ...
          featuredProducts.map((product) => (
            ...
            >
              ...
              <p className="text-[#f04336] font-bold mt-1">${product.price}</p>
              ...
              <Link
                ...
                className="mt-4 inline-block w-full text-center bg-indigo-600 text-white py-2 rounded-md hover:bg-indigo-700"
              >
                View Details
              </Link>
            </div>
